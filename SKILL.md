...
```bash
python3 ~/.claude/skills/xlsx/scripts/recalc.py <excel_file> [timeout_seconds]
```

Example:
```bash
python3 ~/.claude/skills/xlsx/scripts/recalc.py output.xlsx 30
```
